...
//        long currenttime = (Long) session.getAttribute("curtime");
       long currenttime=System.currentTimeMillis();
        long exptime = (Long) session.getAttribute("extime");
        ...
        byte [] encrypt=Base64.getEncoder().encode(newpass.getBytes());
        String newp=new String(encrypt);
        int orgotp = (Integer) session.getAttribute("otp");
...
e.printStackTrace();
    ...
    window.location.href="Acount.html";
        ...
        <script>
            ...
            window.location.href = "inputotp.jsp";
        </script>
        <%
        }
    }
