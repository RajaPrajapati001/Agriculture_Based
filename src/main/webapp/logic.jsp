...
<html>
    ...
    <body>
        ...
        String str=String.valueOf(i);
            String result;
     String newu=request.getParameter("newu");
     session.setAttribute("username",newu);
     String year=request.getParameter("year");
          session.setAttribute("birthyear",year);
     String newp=request.getParameter("newp");
     session.setAttribute("password",newp);
       ...
       out.println(currenttime+"expirytime"+exptime);
       session.setAttribute("extime",exptime);
        response.sendRedirect("inputotp.jsp");
